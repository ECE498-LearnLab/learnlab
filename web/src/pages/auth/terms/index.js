...
const Terms = () => {
  return (
    <div>
      ...
      <p>
        By accessing this website, you agree to abide by these Terms of Service and to comply with
        all applicable laws and regulations. If you do not agree with these Terms of Service, you
        are prohibited from using or accessing this website or using any other services provided by
        LearnLab.{' '}
      </p>
      <p>
        We, LearnLab, reserve the right to review and amend any of these Terms of Service at our
      ...
      <ol>
        ...
        <li>
          ...
          abuses or disrupts our networks or any other service LearnLab provides;
        </li>
        <li>
      ...
      <p>
        ...
        licensed to LearnLab and are protected by applicable copyright and trademark law. We grant
      ...
      <p>
        ...
        and may be terminated by LearnLab at any time.{' '}
      </p>
      <h3>Liability</h3>
      <p>
        Our website and the materials on our website are provided on an &ldquo;as is&rdquo; basis.
        To the extent permitted by law, LearnLab makes no warranties, expressed or implied, and
      ...
      <p>
        In no event shall LearnLab or its suppliers be liable for any consequential loss suffered or
        incurred by you or any third party arising from the use or inability to use this website or
        the materials on this website, even if LearnLab or an authorized representative has been
      ...
      <p>
        ...
        purposes only. LearnLab does not warrant or make any representations concerning the
      ...
      <h3>Links</h3>
      <p>
        LearnLab has not reviewed all of the sites linked to its website and is not responsible for
        the contents of any such linked site. The inclusion of any link does not imply endorsement,
        approval, or control by LearnLab of the site. Use of any such linked site is at your own
